...
export const metadata: Metadata = {
  title: "F1 Elite Motors - Premium Formula 1 Racing Vehicles",
  description: "Experience ultimate performance with our exclusive collection of Formula 1 racing vehicles. Championship-tested engineering meets luxury design.",
  keywords: "F1 vehicles, racing cars, formula 1, premium cars, performance vehicles",
  metadataBase: new URL("https://f1elitemotors.com"),
  alternates: {
    canonical: "https://f1elitemotors.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "F1 Elite Motors - Premium Formula 1 Racing Vehicles",
    description: "Experience ultimate performance with our exclusive collection of Formula 1 racing vehicles.",
    type: "website",
    siteName: "F1 Elite Motors",
    url: "https://f1elitemotors.com"
  },
  twitter: {
    card: "summary_large_image",
    title: "F1 Elite Motors - Premium Racing Vehicles",
    description: "Discover our exclusive Formula 1 vehicles collection"
  }
};
